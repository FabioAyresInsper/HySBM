...
def main():
    # This script does simulations to test if the order of node traversal
    # has an effect on th Gini of hyperedges
    ...
    fn = (f"simulations_nodeOrders/he_distrib_{frac}p_{N_graphs}"
          f"graphs_{N_edges}edges_orders.csv")
